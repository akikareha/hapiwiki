...
extern const char *cgi_input_get_value(struct cgi_input *this, const char *name);
extern const char *cgi_input_get_value_compound(struct cgi_input *this, const char *name);
extern const struct cgi_file *cgi_input_get_file(struct cgi_input *this, const char *name);
